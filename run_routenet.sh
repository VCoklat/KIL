...
if [[ "$1" = "train" ]]; then
    ...
    /opt/conda/envs/ProtoShotXAI/bin/python routenet_with_link_cap.py train --hparams="l2=0.1,dropout_rate=0.5,link_state_dim=32,path_state_dim=32,readout_units=256,learning_rate=0.001,T=8"  --train  /workspaces/KIL/datasets/$2/tfrecords/train/*.tfrecords --train_steps $3 --eval_ /workspaces/KIL/datasets/$2/tfrecords/evaluate/*.tfrecords --model_dir ./CheckPoints/$2
